...
매매 평가는 최대 15종으로 유지하되, 1분봉 표본은 정적 적격 Top30까지 넓힌다.
...
Rule 포트폴리오는 거래대금 상위 15종만 평가한다. Hermes 포트폴리오는 같은
시각의 정적 적격 Top30 snapshot을 받아 16~30위에서도 신호를 찾는다. 다만
가격 셋업·PIT 6세션·이벤트·갭·Risk·개장 후 10분 제한은 동일하게 강제하고,
Hermes가 이 하드 게이트를 우회하지 못한다. 두 포트폴리오는 후보 풀이 달라
동일 universe A/B가 아니라 `rule-top15`와 `hermes-expanded-top30`으로 기록한다.
